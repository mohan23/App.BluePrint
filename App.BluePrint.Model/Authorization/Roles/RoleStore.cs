...
namespace App.BluePrint.UserFramework.Authorization
{
    ...
    /// </summary>
    public abstract class RoleStore<TRole, TTenant, TUser> :
        ...
        where TTenant : TenentDefinition<TTenant, TUser>
    {
        ...
        protected RoleStore(IRepository<TRole> roleRepository, IRepository<RolePermissionSetting, long> rolePermissionSettingRepository, IAbpSession session)
        {
