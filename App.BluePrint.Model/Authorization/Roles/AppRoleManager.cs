...
namespace App.BluePrint.UserFramework.Authorization
{
    ...
    /// </summary>
    public abstract class AppRoleManager<TTenant, TRole, TUser> : RoleManager<TRole, int>, ITransientDependency
        ...
        where TUser : UserDefinition<TTenant, TUser>
    {
        ...
        protected AppRoleManager(RoleStore<TRole, TTenant, TUser> store, IPermissionManager permissionManager)
            : base(store)
        {
