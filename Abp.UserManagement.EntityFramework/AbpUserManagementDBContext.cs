...
{
    public abstract class AbpUserManagementDBContext<TTenant, TRole, TUser> : AbpDbContext
        ...
        where TUser : AbpUser<TTenant, TUser>
    {
        ...
        /// </summary>
        protected AbpUserManagementDBContext()
        {
        ...
        protected AbpUserManagementDBContext(string nameOrConnectionString)
        ...
        /// </summary>
        protected AbpUserManagementDBContext(DbConnection dbConnection, bool contextOwnsConnection)
