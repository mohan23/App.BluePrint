    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("Authentication.Users", t => t.DeleterUserId)
                .ForeignKey("Authentication.Users", t => t.LastModifierUserId)
                .ForeignKey("Tenancy.Tenants", t => t.TenantId)
                .Index(t => t.TenantId)
                .Index(t => t.DeleterUserId)
                .Index(t => t.LastModifierUserId)
                .Index(t => t.CreatorUserId);
        ...
        {
            DropForeignKey("Authentication.Roles", "TenantId", "Tenancy.Tenants");
            ...
            DropForeignKey("Authentication.Users", "TenantId", "Tenancy.Tenants");
            DropForeignKey("Application.Settings", "TenantId", "Tenancy.Tenants");
            DropForeignKey("Tenancy.Tenants", "LastModifierUserId", "Authentication.Users");
            DropForeignKey("Tenancy.Tenants", "CreatorUserId", "Authentication.Users");
            ...
            DropIndex("Tenancy.Tenants", new[] { "CreatorUserId" });
            DropIndex("Tenancy.Tenants", new[] { "LastModifierUserId" });
